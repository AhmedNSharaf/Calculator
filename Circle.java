...
public class Circle implements ActionListener {
    ...
    Circle()
    {
        frame=new JFrame("Circle Calculator");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.setSize(420,550);
        frame.setLayout(null);


        text1=new JTextField("Enter the radius of the circle");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==clrButton) {
			text2.setText("");
            text1.setText("Enter the radius of the circle");
		}
        ...
        if(e.getSource()==area) {
			...
			text2.setText("");
            result1=radius*radius*pi;
            text2.setText(String.valueOf(result1));
            text1.setText("Area of circle is ");
		}
		if(e.getSource()==perimeter) {
            ...
            result1=2*radius*pi;
            text2.setText(String.valueOf(result1));
            text1.setText("Perimeter of circle is ");
		}
