...
public class Square implements ActionListener {
    ...
    JButton area,perimeter,areaAndPerimeter,main,decButton,delButton,clrButton,switchLeft;
    ...
    public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==perimeter) {
            ...
            result1=length*4;
            text2.setText(String.valueOf(result1));
            text1.setText("The perimeter is ");
		}
		if(e.getSource()==areaAndPerimeter) {
            ...
            text1.setText("The Area And Perimeter ");
		}
