...
public class Rectangle implements ActionListener {
    ...
    double [] rectangleParameters = new double[3];
    String[] message = new String[]{"Enter the width of rectangle","Select An Option!"};
    ...
    double result1=0,result2=0,length=0,width=0;
    int i=0;
    Rectangle()
    {
        frame=new JFrame("Rectangle Calculator");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.setSize(420,550);
        frame.setLayout(null);


        text1=new JTextField("Enter the length of rectangle");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==clrButton) {
			text2.setText("");
            text1.setText("Enter the length");
            i=0;
		}
        if(e.getSource()==setInput) {
			rectangleParameters[i] = Double.parseDouble(text2.getText());
			text2.setText("");
        ...
        if(e.getSource()==area) {
			text2.setText("");
            result1=rectangleParameters[0]*rectangleParameters[1];
            text2.setText(String.valueOf(result1));
            text1.setText("Area of rectangle is ");
		}
		if(e.getSource()==perimeter) {
			text2.setText("");
            result1=(rectangleParameters[0]+rectangleParameters[1])*2;
            text2.setText(String.valueOf(result1));
            text1.setText("Perimeter of rectangle is");
		}
		if(e.getSource()==areaAndPerimeter) {
			text2.setText("");
            result1=rectangleParameters[0]*rectangleParameters[1];            result2=(length+width)*2;
            result2=(rectangleParameters[0]+rectangleParameters[1])*2;
