...
public class Cuboid implements ActionListener {
    JFrame frame;
    JButton[] functionButtons = new JButton[9];
    JButton[] numberButtons = new JButton[10];
    double [] CuboidParameters = new double[3];
    String[] message = new String[]{"Enter The Width Of CUboid","Enter the Hieght Of Cuboid","Select An Option!"};
    ...
    Cuboid()
    {
        ...
        text1=new JTextField("Enter The Length Of Cuboid");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==area) {
			text2.setText("");
            result1=(4*CuboidParameters[0]*CuboidParameters[1])+(2*CuboidParameters[1]*CuboidParameters[2]);
            text2.setText(String.valueOf(result1));
            text1.setText("Area Of Cuboid Is");
		}
		if(e.getSource()==Volume) {
			text2.setText("");
            result1=CuboidParameters[0]*CuboidParameters[1]*CuboidParameters[2];
            text2.setText(String.valueOf(result1));
            text1.setText("Volume Of Cuboid Is");
		}
		if(e.getSource()==areaAndVolume) {
			text2.setText("");
            result1=(4*CuboidParameters[0]*CuboidParameters[1])+(2*CuboidParameters[1]*CuboidParameters[2]);
            result2=CuboidParameters[0]*CuboidParameters[1]*CuboidParameters[2];
